...
To get insight into what is happenning we need a little introduction of how numbers are represented in computers.
...
If composer does not fail to install, it is safe to use.